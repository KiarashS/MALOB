...
public class LinkDiscoveryManager implements IOFMessageListener,
    ...
    protected ICurrentStateService cs;
    ...
    protected HashMap<Long, Long> timeStamps;
    ...
    private Command handleLldp(LLDP lldp, long sw, short inPort,
        ...
        long latency = ( end - timeStamps.get(remoteSwitch.getId()) );
        ...
        LinkInfo newLinkInfo = new LinkInfo(firstSeenTime, lastLldpTime,
                                            lastBddpTime, latency);
        cs.addNeigbourLink(lt, latency);
        ...
        if (!isStandard) {
            ...
            LinkInfo reverseInfo = new LinkInfo(firstSeenTime, lastLldpTime,
                                                lastBddpTime, latency);
            cs.addNeigbourLink(reverseLink, latency);
    ...
    protected void discover(long sw, short port) {
    	//starts the discovery of the rtt between switches and the controller
    	cs.getAllControllerRtt(null);
    	//Puts the start time of the lldp packet in a table,
    	//to calculate the latency
    	timeStamps.put(sw, System.currentTimeMillis());
    ...
    public void init(FloodlightModuleContext context)
        ...
        cs = context.getServiceImpl(ICurrentStateService.class);
        
        timeStamps = new HashMap<Long, Long>();
