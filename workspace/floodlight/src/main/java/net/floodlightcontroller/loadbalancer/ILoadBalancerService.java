...
public interface ILoadBalancerService extends IFloodlightService {
	...
	/**
     * List selected service by its ID.
     ...
     * @param LBService service: data structure with caller provided service attributes 
     * @return LBService: Created service 
     */
	public LBService createService(LBService service);

	  /**
     * Update and return an existing service.
     * @param LBService service: data structure with caller provided service attributes 
     * @return LBService: Updated service 
     */
